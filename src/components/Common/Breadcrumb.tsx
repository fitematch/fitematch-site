        ...
        <span className="absolute left-0 top-0 z-[-1]">
          ...
          >
            <path
              ...
              fill="url(#paint0_linear_breadcrumb_left)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_breadcrumb_left"
                x1="-40.5"
                y1="117"
                x2="301.926"
                y2="-97.1485"
        ...
        <span className="absolute right-0 top-0 z-[-1]">
          ...
          >
            <path
              ...
              fill="url(#paint0_linear_breadcrumb_right)"
            />
            <path
              opacity="0.1"
              d="M0.0716344 182.78L101.988 -15.0769L142.154 81.4093L0.0716344 182.78Z"
              fill="url(#paint1_linear_breadcrumb_right)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_breadcrumb_right"
                x1="644"
                y1="221"
                x2="429.946"
                y2="37.0429"
              ...
              <linearGradient
                id="paint1_linear_breadcrumb_right"
                x1="18.3648"
                y1="166.016"
                x2="105.377"
                y2="32.3398"
