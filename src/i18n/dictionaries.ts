  ...
  pt: {
    ...
    faq: {
      ...
      items: [
        ...
        ["As vagas em destaque são diferentes das demais?", "As vagas em destaque recebem mais visibilidade dentro da listagem, mas continuam sendo oportunidades normais cadastradas por recrutadores na plataforma."],
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        ["Are featured jobs different from the others?", "Featured jobs receive more visibility in the listing, but they are still regular opportunities posted by recruiters on the platform."],
