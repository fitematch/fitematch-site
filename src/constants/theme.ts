export const THEME = {
  ...
  pages: {
    ...
    subtitle: 'text-2xl font-bold text-gray-200 hover:text-gray-100',
  },
  ...
  card: {
    ...
    profileCardText: 'text-gray-500 hover:text-gray-700',
    profileCardBackground: 'bg-gray-100',
